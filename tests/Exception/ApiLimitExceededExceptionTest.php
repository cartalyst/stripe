...
class ApiLimitExceededExceptionTest extends TestCase
{
    ...
    {
        $class = ExceptionFactory::create(429, 'Too Many Requests');

        $this->assertInstanceOf(ApiLimitExceededException::class, $class);
        $this->assertSame('Too Many Requests', $class->getMessage());
    }
}
