...
class InvalidRequestExceptionTest extends TestCase
{
    ...
    {
        $class = ExceptionFactory::create(402, 'Request Failed');

        $this->assertInstanceOf(InvalidRequestException::class, $class);
        $this->assertSame('Request Failed', $class->getMessage());
    }
}
